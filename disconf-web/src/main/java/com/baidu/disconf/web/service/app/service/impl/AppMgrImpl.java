...
public class AppMgrImpl implements AppMgr {
    ...
    @Override
	public List<AppListVo> getAuthAppVoList(String name) {
    	List<App> apps = appDao.getByIds(userInnerMgr.getVisitorAppIds());
    	System.out.println(name);
        List<AppListVo> appListVos = new ArrayList<AppListVo>();
        for (App app : apps) {
        	System.out.println(app.getProject()+",");
        	if(name.equals(app.getProject())){
        		System.out.println("==================-------------------------");
        		AppListVo appListVo = new AppListVo();
                appListVo.setId(app.getId());
                appListVo.setName(app.getName());
    ...
    @Override
	public List<ProjectListVo> getAuthProjectVoList() {
    	 List<App> apps = appDao.getByIds(userInnerMgr.getVisitorAppIds());

         List<ProjectListVo> projectListVos = new ArrayList<ProjectListVo>();
         for (App app : apps) {
        	 ProjectListVo projectListVo = new ProjectListVo();
        	 projectListVo.setId(app.getId());
        	 projectListVo.setProjectName(app.getProject());
