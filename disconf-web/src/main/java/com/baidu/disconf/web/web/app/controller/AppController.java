...
import com.baidu.disconf.web.service.app.vo.ProjectListVo;
...
public class AppController extends BaseController {
    ...
    @ResponseBody
    public JsonObjectBase list(String pname) {
    	System.out.println("+++++++++++++++++++"+pname);
        List<AppListVo> appListVos = appMgr.getAuthAppVoList(pname);
        System.out.println(appListVos.size());
    ...
    @ResponseBody
    public JsonObjectBase prolist() {
    	System.out.println("==============================");
        List<ProjectListVo> projectListVos = appMgr.getAuthProjectVoList();

        return buildListSuccess(projectListVos, projectListVos.size());
    }
